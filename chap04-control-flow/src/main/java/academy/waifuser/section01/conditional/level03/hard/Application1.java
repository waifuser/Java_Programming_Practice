...
public class Application1 {
    public static void main(String[] args) {
        ...
        int firstNumber = scAnything.nextInt();
        System.out.print("두 번째 정수 : ");
        int secondNumber = scAnything.nextInt();
        System.out.print("연산 기호를 입력하세요 : ");
        char operator = scAnything.next().charAt(0);
        int result = 0;
        switch (operator) {
            case '+' :
            ...
            case  '/' :
                if(secondNumber == 0){
                    System.out.println("0으로 나누는 것은 정의되지 않습니다. 프로그램을 종료합니다.");
                    return;
                } else {
                    result = firstNumber / secondNumber;
                    break;
